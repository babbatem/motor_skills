...
def main(args):
	...
	os.makedirs('experiments/exps' + '/' + args.exp_name, exist_ok=True)
	config_root = 'experiments/exps' + '/' + args.exp_name + '/' + args.env + '/configs/'
	output_root = 'experiments/exps' + '/' + args.exp_name + '/' + args.env + '/outputs/'
